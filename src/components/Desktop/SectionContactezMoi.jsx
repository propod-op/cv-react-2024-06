			...
			<div className="column left">
				...
				<form onSubmit={handleSubmit}>
					<div className="scotch-contactez-moi-1">
						<Scotch on="desktop" text={"Votre adresse e-mail"} angle={-3} size={"long"} style={{ marginLeft: "4rem" }} />
					</div>
					...
					<div className="scotch-contactez-moi-2">
						<Scotch on="desktop" text={"Votre message"} angle={1} size={"long"} style={{ marginLeft: "2rem" }} />
					</div>
