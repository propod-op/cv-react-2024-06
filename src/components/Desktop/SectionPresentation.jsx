        ...
        <section className={`presentation fade-in ${isVisible ? 'show' : ''}`}>
            <div className="column left">
                <div className="container">
                    ...
                    <p className="texte">
                        Issu de 15 ans d’expérience dans l’imprimerie, j’ai
                        décidé de poursuivre mon parcours dans le domaine du
                        numérique et plus précisément en développement FRONT
                        REACT
                    </p>
