	...
	return (
		<section id="CON" className="contactez-moi">
			<form onSubmit={handleSubmit}>
				...
				<input type="text" name="userName" placeholder="Votre nom" value={formData.userName} onChange={handleChange} required />
				<input type="text" name="userEmail" placeholder="Votre email" value={formData.userEmail} onChange={handleChange} required />
				<input type="text" name="userPhone" placeholder="Votre numéro (optionnel)" value={formData.userPhone} onChange={handleChange} />
				<input type="text" name="messageSubject" placeholder="Votre sujet" value={formData.messageSubject} onChange={handleChange} required />

				<div className="scotch-contactez-moi-3">
					<Scotch on="mobile" text={"Votre message"} angle={1} size={"long"} style={{ marginLeft: "2rem" }} />
				</div>
				<textarea name="messageContent" value={formData.messageContent} onChange={handleChange} required></textarea>
