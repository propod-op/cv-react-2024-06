export const bubblesContent = [
  ...
  },
  {
    ...
    content:
      "A la WildCodeSchool, nous avons étudié les API Rest et comment en créer une avec NodeJS et ExpressJS. Tester la connectivité de l'API (ou d'autres API en ligne) avec Postman. Nous avons aussi étudié GraphQL et TypeGraphQL",
  },
  {
    langage: 'react',
